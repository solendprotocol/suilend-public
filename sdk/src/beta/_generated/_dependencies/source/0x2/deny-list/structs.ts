...
export function isDenyList(type: string): boolean {
  ...
  return type === `${PKG_V23}::deny_list::DenyList`;
}
...
export class DenyList implements StructClass {
  static readonly $typeName = `${PKG_V23}::deny_list::DenyList`;
  static readonly $numTypeParams = 0;

  readonly $typeName = DenyList.$typeName;

  readonly $fullTypeName: `${typeof PKG_V23}::deny_list::DenyList`;
  ...
  private constructor(typeArgs: [], fields: DenyListFields) {
    this.$fullTypeName = composeSuiType(
      DenyList.$typeName,
      ...typeArgs,
    ) as `${typeof PKG_V23}::deny_list::DenyList`;
...
export function isPerTypeList(type: string): boolean {
  type = compressSuiType(type);
  return type === `${PKG_V23}::deny_list::PerTypeList`;
}
...
export class PerTypeList implements StructClass {
  static readonly $typeName = `${PKG_V23}::deny_list::PerTypeList`;
  static readonly $numTypeParams = 0;

  readonly $typeName = PerTypeList.$typeName;

  readonly $fullTypeName: `${typeof PKG_V23}::deny_list::PerTypeList`;
  ...
  private constructor(typeArgs: [], fields: PerTypeListFields) {
    this.$fullTypeName = composeSuiType(
      ...
      ...typeArgs,
    ) as `${typeof PKG_V23}::deny_list::PerTypeList`;
    this.$typeArgs = typeArgs;
