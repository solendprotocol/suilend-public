...
export function isField(type: string): boolean {
  ...
  return type.startsWith(`${PKG_V25}::dynamic_field::Field` + "<");
}
  ...
  implements StructClass
{
  ...
  static readonly $typeName = `${PKG_V25}::dynamic_field::Field`;
  static readonly $numTypeParams = 2;
  static readonly $isPhantom = [false, false] as const;

  readonly $typeName = Field.$typeName;
  readonly $fullTypeName: `${typeof PKG_V25}::dynamic_field::Field<${ToTypeStr<Name>}, ${ToTypeStr<Value>}>`;
  ...
  private constructor(
    ...
    this.$fullTypeName = composeSuiType(
      Field.$typeName,
      ...typeArgs,
    ) as `${typeof PKG_V25}::dynamic_field::Field<${ToTypeStr<Name>}, ${ToTypeStr<Value>}>`;
  ...
  >(
    ...
    return {
      ...
      ) as `${typeof PKG_V25}::dynamic_field::Field<${ToTypeStr<ToTypeArgument<Name>>}, ${ToTypeStr<ToTypeArgument<Value>>}>`,
