...
export function isDisplay(type: string): boolean {
  ...
  return type.startsWith(`${PKG_V25}::display::Display` + "<");
}
...
export class Display<T extends PhantomTypeArgument> implements StructClass {
  ...
  static readonly $typeName = `${PKG_V25}::display::Display`;
  static readonly $numTypeParams = 1;
  static readonly $isPhantom = [true] as const;

  readonly $typeName = Display.$typeName;
  readonly $fullTypeName: `${typeof PKG_V25}::display::Display<${PhantomToTypeStr<T>}>`;
  ...
  private constructor(
    ...
    this.$fullTypeName = composeSuiType(
      Display.$typeName,
      ...typeArgs,
    ) as `${typeof PKG_V25}::display::Display<${PhantomToTypeStr<T>}>`;
  ...
  static reified<T extends PhantomReified<PhantomTypeArgument>>(
    ...
    return {
      ...
      fullTypeName: composeSuiType(
        Display.$typeName,
        ...[extractType(T)],
      ) as `${typeof PKG_V25}::display::Display<${PhantomToTypeStr<ToPhantomTypeArgument<T>>}>`,
...
export function isDisplayCreated(type: string): boolean {
  type = compressSuiType(type);
  return type.startsWith(`${PKG_V25}::display::DisplayCreated` + "<");
}
  ...
  implements StructClass
{
  ...
  static readonly $typeName = `${PKG_V25}::display::DisplayCreated`;
  static readonly $numTypeParams = 1;
  static readonly $isPhantom = [true] as const;

  readonly $typeName = DisplayCreated.$typeName;
  readonly $fullTypeName: `${typeof PKG_V25}::display::DisplayCreated<${PhantomToTypeStr<T>}>`;
  readonly $typeArgs: [PhantomToTypeStr<T>];
  ...
  private constructor(
    ...
    this.$fullTypeName = composeSuiType(
      ...
      ...typeArgs,
    ) as `${typeof PKG_V25}::display::DisplayCreated<${PhantomToTypeStr<T>}>`;
    this.$typeArgs = typeArgs;
  ...
  static reified<T extends PhantomReified<PhantomTypeArgument>>(
    ...
    return {
      ...
      fullTypeName: composeSuiType(
        DisplayCreated.$typeName,
        ...[extractType(T)],
      ) as `${typeof PKG_V25}::display::DisplayCreated<${PhantomToTypeStr<ToPhantomTypeArgument<T>>}>`,
      typeArgs: [extractType(T)] as [
        PhantomToTypeStr<ToPhantomTypeArgument<T>>,
      ],
...
export function isVersionUpdated(type: string): boolean {
  type = compressSuiType(type);
  return type.startsWith(`${PKG_V25}::display::VersionUpdated` + "<");
}
  ...
  implements StructClass
{
  ...
  static readonly $typeName = `${PKG_V25}::display::VersionUpdated`;
  static readonly $numTypeParams = 1;
  static readonly $isPhantom = [true] as const;

  readonly $typeName = VersionUpdated.$typeName;
  readonly $fullTypeName: `${typeof PKG_V25}::display::VersionUpdated<${PhantomToTypeStr<T>}>`;
  readonly $typeArgs: [PhantomToTypeStr<T>];
  ...
  private constructor(
    ...
    this.$fullTypeName = composeSuiType(
      ...
      ...typeArgs,
    ) as `${typeof PKG_V25}::display::VersionUpdated<${PhantomToTypeStr<T>}>`;
    this.$typeArgs = typeArgs;
  ...
  static reified<T extends PhantomReified<PhantomTypeArgument>>(
    ...
    return {
      ...
      fullTypeName: composeSuiType(
        VersionUpdated.$typeName,
        ...[extractType(T)],
      ) as `${typeof PKG_V25}::display::VersionUpdated<${PhantomToTypeStr<ToPhantomTypeArgument<T>>}>`,
      typeArgs: [extractType(T)] as [
        PhantomToTypeStr<ToPhantomTypeArgument<T>>,
      ],
