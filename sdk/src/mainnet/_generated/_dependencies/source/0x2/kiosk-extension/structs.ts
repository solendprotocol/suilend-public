...
export function isExtension(type: string): boolean {
  ...
  return type === `${PKG_V23}::kiosk_extension::Extension`;
}
...
export class Extension implements StructClass {
  static readonly $typeName = `${PKG_V23}::kiosk_extension::Extension`;
  static readonly $numTypeParams = 0;

  readonly $typeName = Extension.$typeName;

  readonly $fullTypeName: `${typeof PKG_V23}::kiosk_extension::Extension`;
  ...
  private constructor(typeArgs: [], fields: ExtensionFields) {
    this.$fullTypeName = composeSuiType(
      Extension.$typeName,
      ...typeArgs,
    ) as `${typeof PKG_V23}::kiosk_extension::Extension`;
...
export function isExtensionKey(type: string): boolean {
  type = compressSuiType(type);
  return type.startsWith(`${PKG_V23}::kiosk_extension::ExtensionKey` + "<");
}
...
{
  static readonly $typeName = `${PKG_V23}::kiosk_extension::ExtensionKey`;
  static readonly $numTypeParams = 1;

  readonly $typeName = ExtensionKey.$typeName;

  readonly $fullTypeName: `${typeof PKG_V23}::kiosk_extension::ExtensionKey<${PhantomToTypeStr<Ext>}>`;
  ...
  private constructor(
    ...
    this.$fullTypeName = composeSuiType(
      ...
      ...typeArgs,
    ) as `${typeof PKG_V23}::kiosk_extension::ExtensionKey<${PhantomToTypeStr<Ext>}>`;
    this.$typeArgs = typeArgs;
  ...
  static reified<Ext extends PhantomReified<PhantomTypeArgument>>(
    ...
    return {
      ...
      fullTypeName: composeSuiType(
        ExtensionKey.$typeName,
        ...[extractType(Ext)],
      ) as `${typeof PKG_V23}::kiosk_extension::ExtensionKey<${PhantomToTypeStr<ToPhantomTypeArgument<Ext>>}>`,
