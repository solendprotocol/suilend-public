...
export class ID implements StructClass {
  static readonly $typeName = `${PKG_V23}::object::ID`;
  static readonly $numTypeParams = 0;

  readonly $typeName = ID.$typeName;

  readonly $fullTypeName: `${typeof PKG_V23}::object::ID`;
...
export function isUID(type: string): boolean {
  type = compressSuiType(type);
  return type === `${PKG_V23}::object::UID`;
}
...
export class UID implements StructClass {
  static readonly $typeName = `${PKG_V23}::object::UID`;
  static readonly $numTypeParams = 0;

  readonly $typeName = UID.$typeName;

  readonly $fullTypeName: `${typeof PKG_V23}::object::UID`;
