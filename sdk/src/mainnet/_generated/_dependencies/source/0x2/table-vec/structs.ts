...
export function isTableVec(type: string): boolean {
  ...
  return type.startsWith(`${PKG_V23}::table_vec::TableVec` + "<");
}
...
{
  static readonly $typeName = `${PKG_V23}::table_vec::TableVec`;
  static readonly $numTypeParams = 1;

  readonly $typeName = TableVec.$typeName;

  readonly $fullTypeName: `${typeof PKG_V23}::table_vec::TableVec<${PhantomToTypeStr<Element>}>`;
  ...
  private constructor(
    ...
    this.$fullTypeName = composeSuiType(
      TableVec.$typeName,
      ...typeArgs,
    ) as `${typeof PKG_V23}::table_vec::TableVec<${PhantomToTypeStr<Element>}>`;
  ...
  static reified<Element extends PhantomReified<PhantomTypeArgument>>(
    ...
    return {
      ...
      fullTypeName: composeSuiType(
        TableVec.$typeName,
        ...[extractType(Element)],
      ) as `${typeof PKG_V23}::table_vec::TableVec<${PhantomToTypeStr<ToPhantomTypeArgument<Element>>}>`,
