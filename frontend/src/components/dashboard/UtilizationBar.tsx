    ...
    <>
      ...
      {passedBorrowLimit &&
        (!passedLiquidationThreshold ? (
          <>
            <span className="mt-2 block max-w-[440px] rounded-md border border-warning/50 p-2">
          ...
          <>
            <span className="mt-2 block max-w-[440px] rounded-md border border-destructive/50 p-2">
